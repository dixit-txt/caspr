...
"""Interactive harness for *chat-while-a-report-is-generating* + the refine router.
    ...
    cd caspr-core && .venv/bin/python src/core/agent/try_respond_during_report.py [--raw]
...
REAL ``RefineRequestRouter`` (``src/core/agent/refine_request_router.py``) so you
...
def _quiet_app_logging() -> None:
    ...
    for loud in ("src.core.observability.llm_response_logger",
                 "src.core.observability.web_search_analytics",
                 "src.core.observability.error_alerter",
                 "src.core.error_alerter",
                 "src.core.cloudwatch_utils"):
...
try:
    with warnings.catch_warnings():
        ...
        from src.core.agent import model as casper_model
        from src.core.agent import refine_request_router as refine_router_mod
        from src.core.agent.refine_request_router import RefineRequestRouter
...
def _silence_side_effects():
    ...
    try:
        import src.core.observability.llm_response_logger as _llmlog
