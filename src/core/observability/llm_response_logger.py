...
def _save_raw_llm_response_impl(
    ...
    try:
        ...
        try:
            from src.core.observability.llm_cost_calculator import attach_cost_to_payload
...
def save_raw_llm_response(
    ...
    """
    try:
        from src.core.observability.functionality_context import resolve_functionality
