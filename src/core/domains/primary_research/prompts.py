...
- Target 60-70% structured formats (bullets, and at most one table), 30-40% narrative.
...
- English only.  No emojis.  Strict analytical / data-centric tone.
- Max 2-3 sentences per paragraph.  Prefer bullet points for findings.
- Single-level bullets only ("- " prefix, one per line, end with period).
