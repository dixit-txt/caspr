...
from src.config.constants import CARD_SUMMARY_MODEL, GEMINI_DRL_GEN_MODEL, GEMINI_SUMMARY_MODEL, S3_REPORTS_BASE_PATH, GEMINI_API_KEY, GEMINI_ES_MODEL_ID
from src.core.visualization.html_graph_maker import generate_html_visualization
from src.core.prompts.prompt_utils import CARD_GEN_JSON_SCHEMA, build_card_gen_prompt, CARD_SUMMARY_PROMPT, CARD_SUMMARY_SCHEMA, CARD_SUMMARY_SCHEMA_GEMINI, DRL_JSON_SCHEMA_OPENAI, DRL_JSON_SCHEMA_GEMINI, DRL_PROMPT, MERGE_CUMULATIVE_SUMMARY_PROMPT, MERGE_CUMULATIVE_SUMMARY_SCHEMA, MERGE_CUMULATIVE_SUMMARY_SCHEMA_GEMINI, NAPKIN_AI_TABLE_TO_VIZ_PROMPT, REFINE_REPORT_LAYOUT_PROMPT, REFINE_REPORT_LAYOUT_SCHEMA, SECTION_OR_SUBSECTION_SUMMARY_PROMPT
from src.core.prompts.prompt_utils import REFINE_CUMULATIVE_SUMMARY_SCHEMA, REFINE_CUMULATIVE_SUMMARY_SCHEMA_GEMINI, REFINE_CUMULATIVE_SUMMARY_PROMPT
from src.core.prompts.prompt_utils import COMPRESS_CONTEXT_SUMMARY_PROMPT, COMPRESS_CONTEXT_SUMMARY_SCHEMA, COMPRESS_CONTEXT_SUMMARY_SCHEMA_GEMINI
...
from src.core.cards.citation_utils import generate_citation_url
from typing import Optional, Dict
import base64
import os
from src.core.integrations.s3_utils import S3_boto3_client
...
def _stream_brief_chunks(
    ...
    """
    from src.core.prompts.prompt_utils import BRIEF_SYSTEM_PROMPT, BRIEF_ARXIV_PRIORITY_ADDENDUM, build_brief_prompt
