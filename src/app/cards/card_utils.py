...
from src.core.agent.analyst_reasoning.schemas import REASONING_KEY
from src.core.cards.citation_utils import generate_citation_url
from src.core.grep_agent_2 import PdfSession
from src.core.grep_agent_2 import ask_pdfs as grep_ask_pdfs

# from src.config.constants import LLM
from src.core.integrations.s3_utils import S3_boto3_client, get_s3_instance
...
from src.core.prompts.prompt_utils import (
    CARD_SUMMARY_PROMPT,
    CARD_SUMMARY_SCHEMA,
...
def parse_markdown_report_layout(report_layout):
    ...
    try:
        ...
        logger.error(f"Error parsing markdown report layout: {str(e)}")
        return []
...
class BriefSectionOutput(BaseModel):
    ...
    content: str = Field(
        ...
        description=(
            ...
            "headings of any kind. Cite every fact or statistic inline as a markdown link "
            "that NAMES the source: [Source Name](https://full-url). Never use bare "
            "numbered citations such as [1], [2] or [3]."
        ),
    )
...
def replace_brief_citations(card: dict, citation_url_map: dict, all_report_citations: list, keep_labels: bool = False) -> dict:
