...
def generate_refined_content(
    ...
    if grep_session is not None:
        ...
        system_content = (
            "You are Caspr, the Trusted Senior Analyst, refining one section of a report. "
            "Hold the voice: conclusions not descriptions, numbers first, the consequence sentence "
            "after data-heavy paragraphs, no hedging language, no exclamation points, and section "
            "titles that state a finding rather than a topic. "
