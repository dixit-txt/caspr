...
down_revision: str | None = "fe8afc0b5a5f"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "tokens_credited_to_referrer", sa.Integer(), nullable=False, server_default="25000"
        ),
        sa.Column(
            "tokens_credited_to_referee", sa.Integer(), nullable=False, server_default="25000"
        ),
    ...
    print("   - Created referrals table with constraints")
