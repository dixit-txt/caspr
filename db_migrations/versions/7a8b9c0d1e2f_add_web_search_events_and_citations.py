...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('trigger_source',      sa.String(30),      nullable=False, comment="'chat', 'card_generation', or 'brief'"),
        sa.Column('section_name',        sa.Text(),          nullable=True,  comment='Report section name (card gen / brief only)'),
        sa.Column('user_query',          sa.Text(),          nullable=True,  comment='Query string sent to the web search'),
        sa.Column('model_used',          sa.String(50),      nullable=True,  comment='OpenAI model, e.g. gpt-4o, gpt-5.4'),
        sa.Column('total_results_count', sa.Integer(),       nullable=True,  comment='Number of URLs returned'),
    ...
    op.create_table(
        'web_search_citations',
        sa.Column('id',                   sa.CHAR(36),        nullable=False, comment='Primary key'),
        sa.Column('search_event_id',      sa.CHAR(36),        nullable=False, comment='FK to web_search_events.id'),
        ...
        sa.Column('domain',               sa.String(255),     nullable=True,  comment='Extracted hostname, e.g. reuters.com'),
        ...
        sa.Column('was_cited_in_output',  sa.Boolean(),       nullable=True,  comment='True if URL cited inline in final output'),
        sa.Column('created_at',           sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    ...
    op.create_index('idx_web_search_citations_search_event_id', 'web_search_citations', ['search_event_id'])
