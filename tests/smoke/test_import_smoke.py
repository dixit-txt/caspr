...
INTENTIONALLY_UNIMPORTABLE = {
    ...
    # Pre-migration copy: superseded by app.cards.service_cards and referenced by
    # nothing. It still imports from the old `src.core.*` tree, so it cannot be
    # imported at all. Remove the file and this entry together.
    "app.cards.card_utils": "pre-migration copy, superseded by app.cards.service_cards",
}
